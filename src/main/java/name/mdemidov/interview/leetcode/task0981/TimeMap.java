package name.mdemidov.interview.leetcode.task0981;
 ...
 * 1 <= timestamp <= 10^7
 * TimeMap.set and TimeMap.get functions will be called a total of 120000 times (combined)
 * per test case.
 *
...
public class TimeMap {
    ...
    public String get(String key, int timestamp) {
        ...
        if (list.isEmpty() || list.get(left).time > timestamp) {
            return "";
        }
    ...
    private class Data {
        ...
        private Data(int time, String value) {
            this.time = time;
            this.value = value;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tm1.get("foo", 2)); // "bar"
