package name.mdemidov.interview.leetcode.task1011;
...
public class Solution {
    ...
    private static boolean isPossible(int capacity, int[] weights, int D) {
        int c = 0;
        int d = 1;
        for (int w : weights) {
            c += w;
    ...
    public static void main(String[] args) {
        // System.out.println(isPossible(2, new int[]{1, 2, 1, 2}, 3));
